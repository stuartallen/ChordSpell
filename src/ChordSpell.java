...
public class ChordSpell {
	
	public static final int[] majorKeySteps = {0,2,2,1,2,2,2};
	public static final int[] minorKeySteps = {0,2,1,2,2,1,2};
	public static final String[] cMajor = {"C","D","E","F","G","A","B"};
	public static final String[] triad = {"2","4"};
	public static final String[] dimTriad = {"2","4b"};
	public static final String[] seventh = {"2","4","6"};
	public static final String[] majSeventh = {"2","4","6^"};
	public static final String[] dimSeventh = {"2","4b","6b"};
	public static final String[] halfDimSeventh = {"2","4b","6"};
	public static final String[] augSevenFlatNineSharpThirteen = {"2","4#","6","8","12b"};
	...
	public static void main(String[] args) {
		ChordAndTab newChord = new ChordAndTab(ChordAndTab.dadgad, "c");
	...
	//returns
	public static int findNoteNum(String note) {
		int sum = 0;
		boolean found = false;
	...
	public static ArrayList keyNoSharpsFlats(String root) {
	...
	public static ArrayList keyNums(String root, int[] tonic) {
	...
	public static ArrayList key(String root, int[] tonic) {
	...
	//Old Chord Function
	/**
	public static ArrayList chord(String root, int[] tonic, String[] intervals) {
		ArrayList key = key(root, tonic);
		ArrayList<String> chord = new ArrayList();
		for(String interval: intervals) {
			if(!interval.contains("#") || !interval.contains("b")) {
				int num = Integer.parseInt(interval);
				String letter = (String) key.get(num);
				chord.add(letter);
			}
		}
		return chord;
	...
	public static int tabOneString(String open, String note) {
	...
	public static String tab(String[] tuning, ArrayList notes) {
